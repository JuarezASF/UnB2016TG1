...
class Camera {
    ...
    vector<double> focal{0, (838.202721973366010 + 841.388786651687380) / 2,
                         (854.792781659906610 + 857.614193372593600) / 2,
                         (834.378121568220080 + 835.838850269775660) / 2,
                         (840.061263941844910 + 841.195974132470720) / 2};
